(()=>{var n=`{% block tinect_oauth_storefront_client_listing_page %}
...
{% endblock %}`;var{Component:M}=Shopware;M.register("tinect-oauth-provider-github-settings",{template:p,props:{item:{required:!0}},computed:{callbackUrl(){return`${window.location.origin}/account/oauth/${this.item.id}/callback`}}});var m=`{% block tinect_oauth_provider_open_id_connect_settings %}
...
{% endblock %}`;var{Component:N}=Shopware;N.register("tinect-oauth-provider-open-id-connect-settings",{template:m,props:{item:{required:!0}}});var h=`{% block tinect_oauth_provider_microsoft_entra_settings %}
...
{% endblock %}`;var{Component:B}=Shopware;B.register("tinect-oauth-provider-microsoft-entra-settings",{template:h,props:{item:{required:!0}},computed:{callbackUrl(){return`${window.location.origin}/account/oauth/${this.item.id}/callback`}}});var f=`{% block tinect_oauth_provider_google_mail_settings %}
