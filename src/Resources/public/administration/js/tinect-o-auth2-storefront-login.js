...
{% endblock %}`;var{Component:z}=Shopware;z.register("tinect-oauth-provider-google-mail-settings",{template:f,props:{item:{required:!0}},computed:{callbackUrl(){return`${window.location.origin}/account/oauth/${this.item.id}/callback`}}});})();
