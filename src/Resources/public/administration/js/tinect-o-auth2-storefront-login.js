...
></tinect-oauth-customer-connected-providers>
{% endblock %}`;Shopware.Component.override("sw-customer-detail-base",{template:u,inject:["acl"]});var p=`{% block tinect_oauth_provider_github_settings %}
...
{% endblock %}`;var{Component:P}=Shopware;P.register("tinect-oauth-provider-microsoft-entra-settings",{template:m,props:{item:{required:!0}},computed:{callbackUrl(){return`${window.location.origin}/account/oauth/${this.item.id}/callback`}}});var f=`{% block tinect_oauth_provider_google_mail_settings %}
...
{% endblock %}`;var{Component:B}=Shopware;B.register("tinect-oauth-provider-google-mail-settings",{template:f,props:{item:{required:!0}},computed:{callbackUrl(){return`${window.location.origin}/account/oauth/${this.item.id}/callback`}}});})();
